...
// GetSize will take an arbitrary type, including struct and map
// and iterate through all values, calculating the memory space
// of both the type of variable, as well as the underlying data.
